                ...
                <div className="footer-grid">
                    ...
                    <div className="footer-brand">
                        <div className="footer-logo">
                            ...
                            <span>Mohammed Afheez</span>
                        </div>
                        <p className="footer-tagline">
                            Full-Stack Developer crafting scalable, high-performance web solutions from Dubai, UAE.
                        </p>
                        <div className="footer-socials">
                            <a href="https://wa.me/971589556227" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="social-btn">
